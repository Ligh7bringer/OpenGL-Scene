...
public:
  ...
  texture(const std::vector<std::string> &filenames, bool anisotropic);
  ...
  texture(const std::vector<glm::vec4> &data, GLuint width, GLuint height, bool mipmaps, bool anisotropic);
